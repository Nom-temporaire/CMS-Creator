...
<div class="mx-auto mt-20 flex flex-col text-xl w-11/12">
    <div>
        ...
        <img class="w-1/3" src="<?= $urlimage ?>" alt="<?= $result->getTitle() ?>">
        ...
        <div class="w-full mt-20">
            <form action="/createcomment" method="post">
                <div class="mb-6">
                    ...
                    <textarea id="commentcontent" name="commentcontent" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="My amazing comment !" required=""></textarea>
                </div>
